...
import com.my.blog.website.config.ImageAttributeProvider;
    ...
    public static DataSource getNewDataSource() {
        if (newDataSource == null) synchronized (TaleUtils.class) {
            if (newDataSource == null) {
                Properties properties = TaleUtils.getPropFromFile("application-prod.yml");
    ...
    public static String mdToHtml(String markdown) {
        ...
        HtmlRenderer renderer = HtmlRenderer
                ...
                .attributeProviderFactory(
                        providerContext -> new ImageAttributeProvider()
                )
                .build();
